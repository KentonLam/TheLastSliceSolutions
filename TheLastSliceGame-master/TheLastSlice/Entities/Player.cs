...
namespace TheLastSlice.Entities
{
    public class Player : Pawn
    {
        ...
        public override void Move(GameTime gameTime)
        {
            ...
            if (TheLastSliceGame.InputManager.IsInputPressed(Keys.Back))
            {
                PizzaIngredients.Clear();
                foreach (var ingredient in TheLastSliceGame.LevelManager.CurrentLevel.CurrentDelivery.Pizza)
                {
                    PizzaIngredients.Add(ingredient);
                }
                TheLastSliceGame.LevelManager.CurrentLevel.DeliverPizza(
                    TheLastSliceGame.LevelManager.CurrentLevel.CurrentDelivery, PizzaIngredients);
            }
